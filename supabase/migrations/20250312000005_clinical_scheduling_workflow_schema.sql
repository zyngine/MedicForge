-- Clinical Scheduling Workflow: Step 2 of 2
-- Tables, functions, and view that use the new booking_status enum values.
--
-- IMPORTANT: Run AFTER 20250312000004 has been applied and committed.
