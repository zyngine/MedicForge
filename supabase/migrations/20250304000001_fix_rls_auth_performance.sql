...
-- Skipped: push_subscriptions, push_notification_logs, notification_preferences
-- These tables exist but have schema mismatches (missing user_id column).
-- RLS policies will be applied when the tables are rebuilt correctly.
